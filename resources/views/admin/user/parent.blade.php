    ...
    <div class="row">
        <div class="col-md-12">
            <div class="email-title">
                <span class="icon mdi mdi-accounts-alt mr-3"></span> Orang Tua
            </div>
        </div>
    </div>
</div>
        ...
        <table id="datatables" class="table datatables table-borderless table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('ortu_edit', $user->id) }}" class="btn btn-xs btn-default" title="Delete">
                            Edit
                        </a>
                        <a href="{{ route('ortu_delete', $user->id) }}" class="btn btn-xs btn-danger delete" title="Delete">
                            Delete
                        </a>
                    </td>
                </tr>
